...
namespace Taschenrechner_V1._0
{
  public partial class Form1 : Form
  {
    ...
    {
      actual_arithmetic = Buttons.ClearCurrentNumber;
      GetArithmeticOperation();
      ResultClicked = true;
      number1 = 0;
      number2 = 0;
    ...
    {
      if (btnSender is not Button button)
        return;

      label1.Text = (label1.Text != "0" && !ResultClicked) switch
      {
        true => label1.Text + button.Text,
        false => button.Text,
      };
    }

    void NumberButton_Click(object sender, EventArgs e) => ActivateButton(sender);
    ...
    private void GetArithmeticOperation()
    {
      switch (actual_arithmetic)             // tracks the method that is klicked
      {
        ...
        case Buttons.Divide:
          result = number1 / number2;
          break;
        case Buttons.ClearCurrentNumber:
          label2.Text = "";
          break;
      }
    }
